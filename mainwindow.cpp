    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->setupUi(this);
    butt *butt1 =new butt(":/butt1.png");//到第一关的按钮
...
void MainWindow::textshow(QPainter *painter){

        painter->save();
        painter->setPen(Qt::yellow);

        painter->drawText(QRect(830,650,350,50),QString("CLICK BELOW TO CHOOSE LEVEL"));//选择关卡的提示
        painter->restore();
